...
//   url: "https://www.nps.gov/yell/index.html",
...
//     description: "Check the current weather and road conditions in Yellowstone National Park."
//   },
// {
//   name: "Fees and Passes",
//   link: "fees.html",
//   image: park.images[3].url,
//   description: "Information about entrance fees and passes for Yellowstone National Park."
// },
// {
//   name: "Vistor Centers",
//   link: "visitorCenters.html",
//   image: park.images[9].url,
//   description: "Find out about the visitor centers in Yellowstone National Park and what they have to offer."
// }
// ];
...
// Step 05: Helper function to reduce repetition
...
// Step 02 & 03: Fetching the specific park
export async function getParkData(parkCode = "yell") {
  const data = await getJson(`parks?parkCode=${parkCode}`);
  return data.data[0]; 
}

// Step 04: New function to handle dynamic images for cards
export function getInfoLinks(images) {
  const parkInfoLinks = [
    {
      name: "Current Conditions",
      link: "conditions.html",
      description: "Check the current weather and road conditions."
    },
    {
      name: "Fees and Passes",
      link: "fees.html",
      description: "Learn about entrance fees and annual passes."
    },
    {
      name: "Visitor Centers",
      link: "visitorcenters.html",
      description: "Find locations and hours for visitor centers."
    }
  ];

  return parkInfoLinks.map((item, index) => {
    // We skip the first two images to get variety for the cards
